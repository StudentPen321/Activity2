 ...
 *      Michael J. Lutz
 *
 * Other Contributer: Eleazar Contreras
 * 1-18-2018
 * SWEN
 * Acknowledgements
 */
...
public class WeatherStation implements Runnable {
    ...
    public void run() {
        ...
        while( true ) {
             ...
             * for more information on formatting outputs
             */
            //
            System.out.printf("Reading is %6.2f degrees C and %6.2f degrees K%n", celsius,  (double)reading/100) ; //put "reading" divide by 100 with decimal and remove percentage and n near C letter
            //System.out.printf("and %6.2f degrees D%n", (double)reading/100);
        }
    }
